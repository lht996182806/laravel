...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form action="/admin/article/update" method="post" class="mws-form" enctype="multipart/form-data">
        @if (count($errors) > 0)
            ...
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="small" name="title" value="{{$list->title}}">
                    </div>
                </div>
                <div class="mws-form-row">
                 ...
                 <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <textarea class="small" cols="" rows="10px" name="descr">{{$list->descr}}</textarea>
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">图片上传</label>
                    <div class="mws-form-item">
                        <img src="{{$list->pic}}" width="100px" alt="">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                    <script id="editor" type="text/plain" style="width:800px;height:300px;">{!!$list->content!!}</script>
