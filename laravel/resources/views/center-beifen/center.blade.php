...
<div class="breadcrumbs">
    <div class="container">
        <a href="http://www.mi.com/index.html" data-stat-id="b0bcd814768c68cc" onclick="_msq.push([&#39;trackEvent&#39;, &#39;45a270e10b1f8e93-b0bcd814768c68cc&#39;, &#39;//www.mi.com/index.html&#39;, &#39;pcpid&#39;]);">首页</a>
        <span class="sep">&gt;</span>
        <span>个人中心</span>    
    </div>
</div>
            ...
            <div class="span4">
                <div class="uc-box uc-sub-box">
                    ...
                    <div class="uc-nav-box">
                        ...
                        <div class="box-bd">
                            <ul class="uc-nav-list">
                                <li><a href="http://service.order.mi.com/record/list?_r=18902.1467980117" data-stat-id="cee379f43f5f5fc2" onclick="_msq.push([&#39;trackEvent&#39;, &#39;45a270e10b1f8e93-cee379f43f5f5fc2&#39;, &#39;http://service.order.mi.com/record/list&#39;, &#39;pcpid&#39;]);">服务记录</a></li>
                                <li><a href="http://service.order.mi.com/apply/fill?_r=18902.1467980117" data-stat-id="49e8df0584b02364" onclick="_msq.push([&#39;trackEvent&#39;, &#39;45a270e10b1f8e93-49e8df0584b02364&#39;, &#39;http://service.order.mi.com/apply/fill&#39;, &#39;pcpid&#39;]);">申请服务</a></li>
                                <li><a href="http://service.order.mi.com/user/compensate?_r=18902.1467980117" data-stat-id="5aedd7982a0a1069" onclick="_msq.push([&#39;trackEvent&#39;, &#39;45a270e10b1f8e93-5aedd7982a0a1069&#39;, &#39;http://service.order.mi.com/user/compensate&#39;, &#39;pcpid&#39;]);">领取快递报销</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="uc-nav-box">
...
<div class="span16">
            ...
            <div class="box-hd">
                ...
                <div class="more clearfix hide">
                    <ul class="filter-list J_addrType">
                        <li class="first active"><a href="http://order.mi.com/user/favorite?r=53893.1468027763" data-stat-id="bb5f4704448262e5">喜欢的商品</a></li>
                        <li><a href="http://order.mi.com/user/favorite?is_sale=0&amp;r=53893.1468027763" data-stat-id="ca8474002200309a">已下架的商品</a></li>
                    </ul>
                </div>
            </div>
            <div class="box-bd">
        ...
        <div class="uc-content-box">
            <div class="box-hd">
                ...
                <div class="more clearfix">
                    <ul class="filter-list J_addrType">
                        <li class="first active"><a href="http://order.mi.com/user/address?r=84119.1468028309" data-stat-id="da703092407b0d55" onclick="_msq.push(['trackEvent', '73ce9fb1e71baa17-da703092407b0d55', 'http://order.mi.com/user/address', 'pcpid']);">普通收货地址</a></li>
                        <li class=""><a href="http://order.mi.com/user/address?type=tv&amp;r=84119.1468028309" data-stat-id="48af064782f152f0" onclick="_msq.push(['trackEvent', '73ce9fb1e71baa17-48af064782f152f0', 'http://order.mi.com/user/address', 'pcpid']);">大型商品收货地址</a></li>
                    </ul>
                </div>
            </div>
            <div class="box-bd">
    ...
    <div id="div4" style="display:none" class="uc-box uc-main-box">
        <div class="uc-content-box order-list-box">
            <div class="box-hd">
                <h1 class="title">我的订单<small>请谨防钓鱼链接或诈骗电话，<a target="_blank" href="//www.mi.com/service/buy/antifraud/" data-stat-id="78d07fef654ba47a" onclick="_msq.push(['trackEvent', '5eab40056fa03ac0-78d07fef654ba47a', '//www.mi.com/service/buy/antifraud/', 'pcpid']);">了解更多&gt;</a></small></h1>
                <div class="more clearfix">
                    <ul class="filter-list J_orderType">
                        <li class="active"><a data-type="0" href="//static.mi.com/order/#type=0" data-stat-id="89d882413195fd4c" onclick="_msq.push(['trackEvent', '5eab40056fa03ac0-89d882413195fd4c', '//static.mi.com/order/#type=0', 'pcpid']);">全部有效订单</a></li>
                        <li ><a data-type="7" href="//static.mi.com/order/#type=7" id="J_unpaidTab" data-stat-id="24ab8a70f05222dc" onclick="_msq.push(['trackEvent', '5eab40056fa03ac0-24ab8a70f05222dc', '//static.mi.com/order/#type=7', 'pcpid']);">待支付</a></li>
                        <li><a data-type="8" href="//static.mi.com/order/#type=8" id="J_sendTab" data-stat-id="8308bdcf62c72b1b" onclick="_msq.push(['trackEvent', '5eab40056fa03ac0-8308bdcf62c72b1b', '//static.mi.com/order/#type=8', 'pcpid']);">待收货</a></li>
                        <li class=""><a data-type="5" href="//static.mi.com/order/#type=5" data-stat-id="d99182d42018ae52" onclick="_msq.push(['trackEvent', '5eab40056fa03ac0-d99182d42018ae52', '//static.mi.com/order/#type=5', 'pcpid']);">已关闭</a></li>
                    </ul>
                    ...
                    @foreach($all as $k=>$v)
                        <li class="uc-order-item uc-order-item-pay">
                         ...
                         <div class="order-detail"> 
                            ...
                            <thead> 
                            <tr> 
                            <th class="col-main"><p class="caption-info">{{$v->created_at}}<span class="sep">|</span>{{session('user')}}<span class="sep">|</span>订单号： <a href="//order.mi.com/user/orderView/1160709744400381" class="number">{{$v->order_num}}</a><span class="sep">|</span>在线支付</p> </th> 
                            ...
                            <tr> 
                                <td class="order-items"> 
                                    <ul class="goods-list">  
                                        <li> 
                                            <div class="figure figure-thumb">   
                                                <a target="_blank" href="//item.mi.com/1160700027.html"> 
                                                <img width="80" height="80" alt="小米手机5 全网通标准版 白色 32GB" src="{{$v->pic}}"> </a>   
                                            </div> 
                                        <p class="name"> <a href="//item.mi.com/1160700027.html" target="_blank">{{$v->title}} {{$v->color}} {{$v->size}}GB</a>  </p> 
    ...
    <div id="div5" style="display:none" style="height:922px" class="xm-line-box uc-box">
        <div class="box-hd">
            ...
            <div class="more">
                <div style="padding-left:22px" class="uc-order-list-type">
                    <a target="_blank" href="http://www.mi.com/service/safe#question" data-stat-id="264d7c39be753897">服务常见问题</a>
                </div>
            </div>
        </div>
        <div style="margin-left:200px;margin-right:20px" class="box-bd">
            <div class="ui-non-purchase">
                ...
                <a target="_blank" class="ui-non-purchase-tip" href="http://www.mi.com/service/safe" data-stat-id="e5c2c140df75999b" style="color:red">了解保障服务</a>
