                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            ...
                            <li><a href="/admin/user/index">查看用户</a></li>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            ...
                            <li><a href="/admin/good/index">浏览商品</a></li>
                            <li><a href="/admin/good/locklist">下架商品</a></li>
                            <!-- <li><a href="form_wizard.html">Wizard</a></li> -->
                        </ul>
                    </li>
                     <li>
                        <a href="#"><i class="icon-gift"></i> 订单管理</a>
                        <ul class="closed">
                            <!-- <li><a href="/admin/good/add">添加商品</a></li> -->
                            <li><a href="/admin/order/index">新订单</a></li>
                            <li><a href="/admin/order/fahuo">待收货</a></li>
                            <li><a href="/admin/order/yishou">已收货</a></li>
                            <!-- <li><a href="form_wizard.html">Wizard</a></li> -->
                        </ul>
                    </li>
                </ul>
