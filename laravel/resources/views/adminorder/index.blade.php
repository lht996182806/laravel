        ...
        <div class="mws-panel-body no-padding">
            ...
            <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                <thead>
                    <tr role="row">
	                    ...
	                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 150px;" aria-label="Browser: activate to sort column ascending">订单号</th>
	                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 160px;" aria-label="Platform(s): activate to sort column ascending">买家ID</th>
	                    ...
	                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 133px;" aria-label="Engine version: activate to sort column ascending">生成时间</th>
            ...
            <tbody role="alert" aria-live="polite" aria-relevant="all">
					...
					@endif
                        ...
                        <td class=" ">
                            <a href="/admin/order/set/{{$v->id}}" class='' style='color:black;font-size:16px'><button class='btn btn-primary'>发货</button></a> 
                        	<a href="/admin/order/xq/{{$v->id}}" class='' style='color:black;font-size:16px'><button class='btn btn-primary'>详情</button></a> 
                        </td>
                    </tr>
                   @endforeach
                </tbody>
