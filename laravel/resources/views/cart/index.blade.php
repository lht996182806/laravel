...
<div class="page-main">
    ...
    <div class="container">
        ...
        <div class="cart-empty hide" id="J_cartEmpty">
            ...
            <a onclick="_msq.push(['trackEvent', '08fae3d5cb3abaaf-4658a7dfd89505fc', '//list.mi.com/0', 'pcpid']);" data-stat-id="4658a7dfd89505fc" href="/hindex" class="btn btn-primary btn-shoping J_goShoping">马上去购物</a>
        </div>
        ...
        {{csrf_field()}}
                        ...
                        <div class="item-table J_cartGoods" data-info="{ commodity_id:'1154500025', gettype:'buy', itemid:'2154500012_0_buy', num:'1'} "> 
                            <div class="item-row clearfix"> 
                                ...
                                <div class="col col-name">  
                                    <div class="tags">   </div>  
                                    <h3 class="name">  
                                         <a href="" target="_blank"> {{$v['name']}} {{$v['color']}} {{$v['size']}}GB </a>  
                                    </h3>   <p class="desc"> <span>适配机型：</span> {{$v['name']}} </p>      
                                </div> 
                                ...
                                <input type="hidden" name="id[]" value="{{$v['id']}}">
                                    <div class="change-goods-num clearfix J_changeGoodsNum"> 
                                        ...
                                        <input tyep="text" name="{{$v['id']}}" value="{{$v['num']}}" data-num="1" data-buylimit="50" autocomplete="off" class="goods-num"> 
                                        <a class="J_plus" href="javascript:void(0);"><i class="iconfont" onclick="plus(this)"></i>
                                        </a>  
                                    </div> 
                                 </div> 
                                 <div class="col col-total" > <span name="p">{{$v['price']*$v['num']}}</span>元 <p class="pre-info">  </p> 
                                 </div> 
                                 <div class="col col-action"> <a id="2154500012_0_buy" data-msg="确定删除吗？" onclick="del({{$v['id']}})" href="javascript:void(0);" title="删除" class="del J_delGoods"><i class="iconfont"></i>
                                 </a> 
                                 </div> 
                            </div> 
                        </div>    
            ...
            <div class="cart-bar clearfix cart-bar-fixed" id="J_cartBar">
                <div class="section-left">
                    <a onclick="_msq.push(['trackEvent', '08fae3d5cb3abaaf-3d1e5bdd191768c8', '#', 'pcpid']);" data-stat-id="3d1e5bdd191768c8" href="/hindex" class="back-shopping J_goShoping">继续购物</a>
