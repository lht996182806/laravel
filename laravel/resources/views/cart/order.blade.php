...
<div class="site-header site-mini-header">
    <div class="container">
        ...
        <span class="user"><a onclick="_msq.push(['trackEvent', '50d1f382fadafb8b-de9e238ee20c2ea1', '//my.mi.com/portal', 'pcpid']);" data-stat-id="de9e238ee20c2ea1" rel="nofollow" class="user-name" href="" target="_blank"><span class="name">{{session('user')}}</span><i class="iconfont"></i></a>
        <ul class="user-menu">
            <li><a onclick="_msq.push(['trackEvent', '50d1f382fadafb8b-e0b9e1d1fa8052a2', '//my.mi.com/portal', 'pcpid']);" data-stat-id="e0b9e1d1fa8052a2" rel="nofollow" href="/center" target="_blank">个人中心</a>
            </li>
            <li><a onclick="_msq.push(['trackEvent', '50d1f382fadafb8b-04dda61fe46ba720', 'http://order.mi.com/user/comment', 'pcpid']);" data-stat-id="04dda61fe46ba720" rel="nofollow" href="" target="_blank">评价晒单</a>
            </li>
            <li><a onclick="_msq.push(['trackEvent', '50d1f382fadafb8b-8660c1b13ab1c56b', 'http://order.mi.com/user/favorite', 'pcpid']);" data-stat-id="8660c1b13ab1c56b" rel="nofollow" href="" target="_blank">我的喜欢</a>
            </li>
            <li><a onclick="_msq.push(['trackEvent', '50d1f382fadafb8b-6c2aba14bc7f649a', 'http://account.xiaomi.com/', 'pcpid']);" data-stat-id="6c2aba14bc7f649a" rel="nofollow" href="" target="_blank">小米账户</a>
            </li>
                    ...
                    @foreach($goods as $v)
                        <li class="clearfix">
                            ...
                            <input type="hidden" name="{{$v['id']}}" value="{{$v['number']}}">
                                <a onclick="_msq.push(['trackEvent', '50d1f382fadafb8b-a983b35036d10e6c', '//item.mi.com/1160700027.html', 'pcpid']);" data-stat-id="a983b35036d10e6c" href="" target="_blank">{{$v['title']}} {{$v->color}} {{$v->size}} G</a>
                            </div>
